define({ "api": [
  ...
  },
  {
    ...
    "name": "Modify",
    "group": "Users",
    "description": "<p>Modify preference(s) on users profile.</p> <p>TYPES:</p> <p>Single: Make a change to a single profile value.</p> <p>Multiple: Send a JSON representation of all the values to be overwritten in the profile.</p> <p>MODES:</p> <p>modify: Modifies an existing non-list value.</p> <p>remove: Removes a key/value pair. If used on an list, the entire list is removed.</p> <p>listappend: Appends a value to an existing list.</p> <p>listremove: Removes a value from an existing list.</p>",
    "header": {
      "fields": {
        "Header": [
          {
  ...
  },
  {
    ...
    "name": "UpdateRatings",
    "group": "Users",
    "description": "<p>Allows front-end to update city match ratings for the current user.</p>",
    "header": {
      "fields": {
        "Header": [
          {
